...
Ext.define('Ext.Img', {
    ...
    updateMode: function(mode) {
        ...
        if (mode === 'background') {
            ...
            me.imageElement = me.element.createChild({ tag: 'images' });
