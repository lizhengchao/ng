        ...
        items: [
            {
                ...
                itemTpl: ['<a href="test.docx"></a><div style="padding: 11px 13px;<tpl if=\"isbizcontent==1\">display:none;</tpl>"><div style="position: relative;"><div style="background-image:url({icon});background-repeat: no-repeat;background-position: center;background-size: 40px 40px;width: 40px;height: 40px;"></div>',
